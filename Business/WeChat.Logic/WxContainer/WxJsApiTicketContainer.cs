...
namespace WeChat.Logic.WxContainer
{
    ...
    /// </summary>
    public class WxJsApiTicketContainer
    {
        ...
        /// <param name="getNewTicket"></param>
        /// <returns></returns>
        public static JsApiTicketResult TryGetTicketResult(string appId, string appSecret, bool getNewTicket = false)
        {
            if (!CheckRegistered(appId) || getNewTicket)
            {
                Register(appId, appSecret);
            }
            return GetTicketResult(appId, getNewTicket);
        }
