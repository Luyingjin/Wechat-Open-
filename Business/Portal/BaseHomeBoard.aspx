<%@ Page Language="c#" CodeBehind="BaseHomeBoard.aspx.cs" AutoEventWireup="true"
    Inherits="Portal.Door.BaseHomeBoard" %>
...
<head>
    ...
    <script language="JScript" type="text/javascript">
        ...
        DRAG_URL = "/Portal/Door/BaseBlockData.aspx";
        ...
        function resizeContent() {
            ...
            jQuery("#Divlayout").width(jQuery("body").width());
        }
        ...
        function delDragDiv(blockid) {
            ...
            if (logicv) {
                ...
                jQuery.ajax({ url: "door/BaseBlockData.aspx", type: "post", data: jQuery.extend({}, { Param: "DeleteBlock", BlockId: blockid }, _params),
                    success: function (resp) {
	...
	(
        ...
        function setLayoutType(n) {
            ...
            var url = "Door/BaseBlockData.aspx";
        ...
        function addCol2() {
            ...
            newColDiv.id = "col_2";
            newColDiv.style.width = parseFloat(col2Width) - 0.5 + "%";
        ...
        function addCol3() {
            ...
            newColDiv.className = "col_div";
            newColDiv.id = "col_3";
            newColDiv.style.width = parseFloat(col3Width) - 0.5 + "%";
            newColDiv.innerHTML = colAry.join("");
            col1.parentNode.insertBefore(newColDiv, null);
            initDrag();
        }
        ...
        function addCol4() {
            ...
            newColDiv.className = "col_div";
            newColDiv.id = "col_4";
            newColDiv.style.width = parseFloat(col4Width) - 0.5 + "%";
            newColDiv.innerHTML = colAry.join("");
            col1.parentNode.insertBefore(newColDiv, null);
            initDrag();
        }
...
<body style="width: 100%; height: 100%; overflow: hidden">
    ...
    <div id="popupImgMenuID" style="display: none; position: absolute">
        ...
        <div id="loadimgid" style="width: 100px">
            <img src="Door/image/loading.gif" align="absMiddle"><span id="loadtext" style="color: #333"></span></div>
    </div>
    ...
    <div id="popupConMenuID" style="border-right: #a2c7d9 1px solid; padding-right: 5px;
        ...
        <div id="paneladdcontent" style="overflow: auto; width: 100%; height: 300px" align="left">
            <div id="coleditcon" style="width: 100px">
                <img src="Door/image/loading.gif"><span id="coleditcontext" style="color: #333"></span></div>
        </div>
        <div style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; width: 180px;
            color: #222; padding-top: 5px">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ExecuteDesignTaskList(taskName, id, wbsFullID) {
            openWindow("/MvcConfig/Workflow/Task/DesignTaskProductList?WBSFULLID=" + wbsFullID, { title: taskName, width: "880", height: "650", onDestroy: function () { if (GetTaskList) GetTaskList('UndoDesign'); } });
        }
        ...
        function MoreTask() {
            openWindow("/MvcConfig/Workflow/Task/UnFinishedList", { width: 1050, height: 650 });
        }
