...
namespace WeChatTask.Common
{
    ...
    public class DBHelper
    {
        ...
        public static DBHelper CreateDBHelper(string connName)
        {
            string key = string.Format("Conn_{0}", connName);

            DBHelper sqlHelper = new DBHelper(ConfigurationManager.ConnectionStrings[connName].ConnectionString, ConfigurationManager.ConnectionStrings[connName].ProviderName);
        ...
        /// <returns></returns>
        public string ExecuteNonQuery(string sqlQuery, bool isTransaction = false)
        {
            return ExecuteNonQuery(sqlQuery, CommandType.Text, isTransaction);
        }
        ...
        /// <returns></returns>
        public string ExecuteNonQuery(string sqlQuery, int timeOut, bool isTransaction = false)
        {
            return ExecuteNonQuery(sqlQuery, CommandType.Text, timeOut, isTransaction);
        }
        ...
        /// <returns></returns>
        public string ExecuteNonQuery(string sqlQuery, CommandType cmdtype, bool isTransaction = false)
        {
            return ExecuteNonQuery(sqlQuery, cmdtype, null, isTransaction);
        }
        ...
        /// <param name="timeOut">延迟等待时间</param>
        /// <returns></returns>
        public string ExecuteNonQuery(string sqlQuery, CommandType cmdtype, int timeOut, bool isTransaction = false)
        {
            return ExecuteNonQuery(sqlQuery, cmdtype, timeOut, null, isTransaction);
        }
        ...
        /// <param name="cmdtype">命令类型</param>
        /// <returns></returns>
        public string ExecuteNonQuery(string sqlQuery, CommandType cmdtype, DbParameter[] parms, bool isTransaction = false)
        {
            return ExecuteNonQuery(sqlQuery, cmdtype, 30, parms, isTransaction);
        }
        ...
        /// <param name="timeOut">延迟等待时间</param>
        /// <returns></returns>
        public string ExecuteNonQuery(string sqlQuery, CommandType cmdtype, int timeOut, DbParameter[] parms, bool isTransaction = false)
        {
            string retVal = "0";
